    ...
    >
      <v-tab-item>
        <v-list v-if="items" two-line>
          ...
          >
            <div v-for="(item, index) in items" :key="'conv' + index">
      ...
      <v-tab-item>
        ...
        <v-list v-else two-line>
          <v-list-item-group v-model="selected2" active-class="pink--text">
            <div v-for="(item, index) in 9" :key="index">
              <v-list-item>
                <template v-slot:default="{ active }">
                  <v-list-item-avatar class="img-user" rounded="0">
      ...
      <v-tab-item>
        ...
        <v-list v-else two-line>
          <v-list-item-group v-model="selected3" active-class="pink--text">
            <div v-for="(item, index) in 9" :key="index">
              <v-list-item>
                <template v-slot:default="{ active }">
                  <v-list-item-avatar class="img-user" rounded="0">
      ...
      <v-tab-item>
        <v-list two-line>
          <v-list-item-group
            ...
            active-class="pink--text"
          >
            <div v-for="(item, index) in resultSearch" :key="index">
              <v-list-item @click="showconversation(item)">
                <template v-slot:default="{ active }">
                  <v-list-item-avatar class="img-user" rounded="0">
                    <v-img :src="item.avatar"></v-img>
  ...
  methods: {
    ...
    searchDiscussion() {
      ...
      this.debounce = setTimeout(() => {
        this.$axios
          .get(`/api/messenger/search-conversation/${this.search}`)
          .then((res) => {
            this.resultSearch = [];
    ...
    showconversation(item) {
      this.$store.commit("chat/changediscussioninPage", {
        ...
        target_user: {
          ...
          name: item.title,
          img: item.avatar,
          friendscount: item.friendscount ? item.friendscount : "0",
